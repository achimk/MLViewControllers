...
typedef NS_ENUM(NSUInteger, MLRowTestControllers) {
    MLRowTestControllerCenterViews,
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    dispatch_once(&onceToken, ^{
        mapping = @{
                    ...
                    //MLSectionTestControllers
                    INDEX(MLSectionTestControllers, MLRowTestControllerCenterViews)                     : @"MLCenterViewController",
                    };
    });
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    dispatch_once(&onceToken, ^{
        mapping = @{
                    ...
                    //MLSectionTestControllers
                    INDEX(MLSectionTestControllers, MLRowTestControllerCenterViews)                     : @"Center Views",
                    };
    });
