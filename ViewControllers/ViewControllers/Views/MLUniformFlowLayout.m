...
@implementation MLUniformFlowLayout
...
- (CGFloat)getHeaderHeightInSection:(NSInteger)section {
    ...
    id<MLUniformFlowLayoutDelegate> delegate = (id<MLUniformFlowLayoutDelegate>)self.collectionView.delegate;
...
- (void)setInterItemSpacing:(MLInterItemSpacing)interItemSpacing {
